...
from core.utils.security_utils import sanitize_path, is_safe_path
...
# Security functions for backward compatibility
def validate_path_security(path: str, allowed_roots=None) -> bool:
    """Validate path security - wrapper around is_safe_path"""
    return is_safe_path(path, allowed_roots)
