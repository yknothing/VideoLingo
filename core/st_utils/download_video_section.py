    ...
    with st.container(border=True):
        ...
        try:
            ...
            with col2:
                ...
                st.warning(
                    "⚠️ **Note:** This video may not correspond to your current URL. Use 'Delete and Reselect' to download the correct video."
                )
            ...
            if st.button(t("Download Video"), key="download_video_button"):
                if url:
                    ...
                    download_state = {"phase": "initializing", "error": None, "completed": False}
                        ...
                        try:
                            ...
                            if status == "downloading":
                                ...
                                progress_bar.progress(
                                    min(progress, 0.99)
                                )  # Keep some margin for completion
                                ...
                                if "speed_str" in progress_data and "eta_str" in progress_data:
                                    ...
                                    info_text.text(
                                        f"Size: {total_size} | Speed: {speed} | ETA: {eta}"
                                    )
                                else:
                                    ...
                                    if total > 0:
                                        ...
                                        if speed > 0:
                                            ...
                                            info_text.text(
                                                f"Downloaded: {downloaded/1024/1024:.1f}MB / {total/1024/1024:.1f}MB | Speed: {speed_mb:.1f}MB/s"
                                            )
                                        else:
                                            info_text.text(
                    ...
                    try:
                        ...
                        downloaded_video = download_video_ytdlp(
                            url, resolution=res, progress_callback=progress_callback
                        )
                        ...
                        if not downloaded_video:
                            ...
                            st.info(
                                "This might indicate a network issue or the video is not accessible"
                            )
                            return
                        ...
                        if is_valid:
                            ...
                            info_text.text(
                                f"File: {os.path.basename(downloaded_video)} ({file_size_mb:.1f}MB)"
                            )
                            ...
                            st.warning(
                                f"⚠️ Download completed but validation failed: {validation_msg}"
                            )
                        ...
                        if "yt-dlp command failed" in error_msg:
                            st.error(
                                "❌ **Download Tool Error**: The download tool encountered an error."
                            )
                            st.info("💡 **Possible solutions:**")
                            st.write("- Check your internet connection")
                            st.write("- Verify the video URL is correct and accessible")
            ...
            if uploaded_file:
                ...
                try:
                    ...
                    if is_valid:
                        ...
                        st.info(f"📊 File size: {file_size_mb:.1f}MB")
                        st.info(
                            "💡 Please check if the file is a valid video format and not corrupted."
                        )
            ...
            if "No video files found" in error_msg:
                ...
                st.warning(
                    "⚠️ Multiple video files detected. The system will automatically select the best one."
                )
            elif "No valid video files found" in error_msg:
                st.error(
                    "❌ Downloaded files appear to be corrupted or incomplete. Please try downloading again."
                )
                # Show cleanup option
